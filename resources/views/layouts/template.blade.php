    ...
    <div class="container">
        <div class="menu-content">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="/img/front/logo.png" alt=""></a>
            </div>
...
<div id="footer">
    <div class="footer-instagram-section">
        ...
        <div id="footer-instagram" class="owl-carousel">
            ...
            <div class="item">
                <a href="#"><img src="/img/front/ins-1.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-2.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-3.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-4.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-5.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-6.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-7.jpg" alt=""></a>
            </div>
            <div class="item">
                <a href="#"><img src="/img/front/ins-8.jpg" alt=""></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="/img/front/footer-logo.png" alt=""></div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <img src="/img/front/author.png" alt="">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <a href="#"><img src="/img/front/footer-img.png" alt=""></a>
                        </div>
                        <div>
